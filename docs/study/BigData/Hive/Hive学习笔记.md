...
（下面操作HDFS的HQL步骤出问题了，报错，暂时没解决）

```error
hive> INSERT OVERWRITE DIRECTORY '/tmp/hdfs_out' SELECT a.* FROM invites a WHERE a.ds='2008-08-15';
Query ID = ashiamd_20210127031636_5a2bc961-d449-4d54-9081-dfb8c305481b
Total jobs = 3
Launching Job 1 out of 3
Number of reduce tasks is set to 0 since there's no reduce operator
Starting Job = job_1611672954020_0005, Tracking URL = http://ashiamddeMBP:8088/proxy/application_1611672954020_0005/
Kill Command = /Users/ashiamd/mydocs/dev-tools/hadoop/hadoop-3.3.0/bin/mapred job  -kill job_1611672954020_0005
Hadoop job information for Stage-1: number of mappers: 0; number of reducers: 0
2021-01-27 03:17:19,432 Stage-1 map = 0%,  reduce = 0%
Ended Job = job_1611672954020_0005 with errors
...
上面这个说是jdk问题，已经卸载11了，该用jdk8了，变成下面这个错误了
...
```shell
021-01-27 05:40:19,395 INFO [main] org.apache.hadoop.service.AbstractService: Service org.apache.hadoop.mapreduce.v2.app.MRAppMaster failed in state INITED
...
Caused by: java.net.SocketException: Call From ashiamddeMBP/192.168.31.17 to localhost:9000 failed on socket exception: java.net.SocketException: Software caused connection abort; For more details see:  http://wiki.apache.org/hadoop/SocketException
	at sun.reflect.NativeConstructorAccessorImpl.newInstance0(Native Method)
	at sun.reflect.NativeConstructorAccessorImpl.newInstance(NativeConstructorAccessorImpl.java:62)
	at sun.reflect.DelegatingConstructorAccessorImpl.newInstance(DelegatingConstructorAccessorImpl.java:45)
	at java.lang.reflect.Constructor.newInstance(Constructor.java:423)
...
Caused by: java.net.SocketException: Software caused connection abort
	...
	at org.apache.hadoop.ipc.Client.call(Client.java:1452)
	... 29 more
2021-01-27 05:40:19,397 ERROR [main] org.apache.hadoop.mapreduce.v2.app.MRAppMaster: Error starting MRAppMaster
org.apache.hadoop.yarn.exceptions.YarnRuntimeException: Error while initializing
	at org.apache.hadoop.mapreduce.v2.app.MRAppMaster.serviceInit(MRAppMaster.java:368)
	at org.apache.hadoop.service.AbstractService.init(AbstractService.java:164)
	at org.apache.hadoop.mapreduce.v2.app.MRAppMaster$6.run(MRAppMaster.java:1760)
...
Caused by: java.net.SocketException: Software caused connection abort
	...
	at org.apache.hadoop.ipc.Client.call(Client.java:1452)
	... 29 more
2021-01-27 05:40:19,398 INFO [main] org.apache.hadoop.util.ExitUtil: Exiting with status 1: org.apache.hadoop.yarn.exceptions.YarnRuntimeException: Error while initializing
